...
public class DetailActivitePro extends MenuDrawerNew implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TV_nbrVu = (TextView) findViewById(R.id.nbvu);
    ...
    private void ouvrePopUpModifier() {// Ouvre le popup pour la saisie du profil
        ...
        LayoutInflater factory = LayoutInflater.from(DetailActivitePro.this);
    ...
    private void updateActivite(int idpersonne, Activite activiteSelectionne, String titre, String libelle, int nbmaxWaydeurs) {
        new AsyncTaches.AsyncUpdateActivite(this, idpersonne, activiteSelectionne.getId(), titre, libelle, nbmaxWaydeurs, DetailActivitePro.this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    private void gestionInscription() {
        ...
        IB_Inscription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DetailActivitePro.this);
    ...
    private void participeActivite() {
        new AsyncTaches.AsyncAddParticipation(this, activiteSelectionne.getIdorganisateur(), activiteSelectionne.getId(), DetailActivitePro.this)
    ...
    private void annuleActivite() {
        ...
        new AsyncTaches.AsyncEffaceActivite(this, Outils.personneConnectee.getId(), idactivite, DetailActivitePro.this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    private void annuleParticipation() {
        ...
        new AsyncTaches.AsyncEffaceParticipation(this, Outils.personneConnectee.getId(), Outils.personneConnectee.getId(), idactivite, DetailActivitePro.this)
                .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    public void onClickParticipant(Participant participant, int position) {
        Intent appel;
        appel = new Intent(DetailActivitePro.this, UnProfil.class);
    ...
    private void effaceParticipant(Participant participant) {
        ...
        new AsyncTaches.AsyncEffaceParticipation(this, Outils.personneConnectee.getId(), participant.getId(), activiteSelectionne.getId(), DetailActivitePro.this)
                .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
