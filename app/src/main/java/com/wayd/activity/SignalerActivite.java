...
public class SignalerActivite extends MenuNoDrawer implements AsyncTaches.AsyncSignalActivite.Async_SignalActiviteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.signaleractivites);
        InitDrawarToolBar();
        initTableauDeBord();
    ...
    private void dialogConfirmation() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SignalerActivite.this);
    ...
    private void dialogRaison() {// Ouvre le popup pour la saisie du profil
        ...
        LayoutInflater factory = LayoutInflater.from(SignalerActivite.this);
    ...
    private void signaleActivite() {
      new AsyncTaches.AsyncSignalActivite(this, Outils.personneConnectee.getId(), idactivite, idmotif, motif, titreActivite, libelleActivite, SignalerActivite.this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
