...
public class SignalerProfil extends MenuNoDrawer implements AsyncTaches.AsyncSignalProfil.Async_SignalProfilListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.signalerprofils);
        InitDrawarToolBar();
        initTableauDeBord();
        idpersonne = getIntent().getIntExtra("idpersonne", 0);
        String pseudo = getIntent().getStringExtra("pseudo");
        TextView TV_Harcele = (TextView) findViewById(R.id.harcele);
        TextView TV_Insultant = (TextView) findViewById(R.id.insultant);
        TextView TV_Entreprise = (TextView) findViewById(R.id.entreprise);
        TextView TV_Autre = (TextView) findViewById(R.id.autre);
        TextView TV_Titre = (TextView) findViewById(R.id.titreprofil);
        TV_Titre.setText(getString(R.string.SignalerProfil_description)+ pseudo);
    ...
    private void dialogConfirmation() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SignalerProfil.this);
    ...
    private void dialogRaison() {// Ouvre le popup pour la saisie du profil
        ...
        LayoutInflater factory = LayoutInflater.from(SignalerProfil.this);
    ...
    private void signalerProfil() {
        ...
        new AsyncTaches.AsyncSignalProfil(this, Outils.personneConnectee.getId(), idpersonne, idmotif, motif, SignalerProfil.this)
